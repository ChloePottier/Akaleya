    ...
    <div class='container'>
        ...
        <div class='row py-3'>
                <div class='col-12 col-md-4 fs-2 nav-footer order-md-last'><!--Réseaux sociaux-->
                    ...
                    <div class='d-flex flex-row justify-content-center font-size-56 ' id='link-rs-footer'>
                ...
                <div class='col-12 col-md-4 text-center text-md-start text-blue font-size-13 mb-3 mb-lg-0'><!--Menu pages légales-->
                ...
                <p class='mb-0 pb-0'>Site éco-conçus par <a href='https://akaleya.fr' class='font-weight-bold' id='copy-akaleya'>Akaleya</a> - Copyright © 2021</p>
