    <li itemprop='itemListElement' itemscope itemtype='https://schema.org/ListItem'>
        <a href='<?php echo esc_url( home_url( "/" ) ); ?>/espace-membres' class='text-prune-dark' itemprop='item'>
            <span itemprop='name'>Espace privé</span><meta itemprop='position' content='1'/>
        </a>
    </li>
    ...
    <!-- <li itemprop='itemListElement' itemscope itemtype='https://schema.org/ListItem'>
        ...
        ' class='text-prune-dark' itemprop='item'>
            <span itemprop='name'>Mon compte</span><meta itemprop='position' content='2'/>
        </a>
    </li> -->
    <li itemprop='itemListElement' itemscope itemtype='https://schema.org/ListItem'>
        <a href='<?php echo esc_url( home_url( "/" ) ); ?>#section-contact' class='text-prune-dark' itemprop='item'>
            <span itemprop='name'>Contact</span><meta itemprop='position' content='3'/>
        </a>
    </li>
    <li itemprop='itemListElement' itemscope itemtype='https://schema.org/ListItem'>
