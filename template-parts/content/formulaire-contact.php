<form method="POST" class="pb-sm-6 w-75" id="contactForm" data-toggle="validator" role="form">
    ...
    <button id="form-submit" class="bg-prune-dark font-family-bebas font-size-24 text-blue  border-0 mb-5 " type="submit">ENVOYER</button>
